...
global.botname = process.env.BotName || "Explore Lanka" 
global.author = process.env.Author || "@Nadeesha Dilshan " 
global.packname = process.env.PackName || "Queen Anya v2 MD" 
global.myweb = process.env.Web || "https://github.com/PikaBotz" 
global.footer = process.env.Footer || "© Queen Anya Bot" 
global.prefa = process.env.Prefix || ['-'] 
global.themeemoji = process.env.ThemeEmoji || "🎐" 
global.ownername = process.env.Owner_Name || "Nadeesha Dilshan " 
global.ownernumber = process.env.Owner_Number || "94756695376" 
global.adress = process.env.Continent || "Asia, India, Assam" 
global.timezone = process.env.TimeZone || "Asia/Colombo " 
global.instagramId = process.env.Insta || "8.08_only_mine" 
global.email = process.env.Email_Id || "example@example.com" 

global.mongoUrl = process.env.MongoDB || "mongodb+srv://nadeesha100:Nadeesha@2007@cluster0.xw66q7b.mongodb.net/"; 
...
module.exports = {
  botname: process.env.BotName || "Explore Lanka", 
  author: process.env.Author || "@Nadeesha ",
  packname: process.env.PackName || "Explore Lanka MD",
  myweb: process.env.Web || "https://github.com/PikaBotz",
  footer: process.env.Footer || "© Explore Lanka BOT",
  prefa: process.env.Prefix || ['.'],
  themeemoji: process.env.ThemeEmoji || "🎐",
  ownername: process.env.Owner_Name || "Nadeesha Dilshan ",
  ownernumber: process.env.Owner_Number || "94756695376",
  ...
  mongoUrl: process.env.MongoDB || "mongodb+srv://nadeesha100:Nadeesha@2007@cluster0.xw66q7b.mongodb.net/",
  welcome: process.env.Welcome_Msg || '*@$user* joined this group today as $membersth member.\n\n_$prefix welcome off to disable this message._',
  left: process.env.Left_Msg || 'Ex-member *@$user* is no longer available in this group chat.\n\n_$prefix goodbye off to disable this message._',
  promote: process.env.Promote_Msg || '*@$user* has been promoted as an admin in this group.\n\n_$prefix promotem off to disable this message._',
  demote: process.env.Demote_Msg || '*@$user* has been demoted to a member in this group.\n\n_$prefix demotem off to disable this message._',
  sessionId: process.env.SESSION_ID || "Z1ZkN20_Queen-Anya_xTGY=", 
